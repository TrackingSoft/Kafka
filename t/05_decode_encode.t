...
# a encoded produce request hex stream
my $encoded_SNAPPY = pack( 'H*', '0000006f000000000000000400000001000005dc0000000100076d79746f70696300000001000000000000004600000000000000000000003a2ce564450002ffffffff0000002c440000190158161eb980d10000ffffffff0000000848656c6c6f20312119211400163594d3123e2200043221' );

is_deeply( decode_produce_request( \$encoded_SNAPPY ), $decoded, 'decoded correctly' );
is( encode_produce_request( $decoded, $COMPRESSION_SNAPPY ), $encoded_SNAPPY, 'encoded correctly' );
