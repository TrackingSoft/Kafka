...
my $uncomplessed = Kafka::Protocol::snappy_xerial_decompress($snappy_data_2_frames);
is length($uncomplessed), 52351, 'xerial unpacker unpack multiple frames data correctly';
is Kafka::Protocol::snappy_xerial_compress($uncomplessed), $snappy_data_2_frames, 'xerial packer roundtrip ok';
